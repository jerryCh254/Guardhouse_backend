...
const { createDocumentSchema, updateDocumentSchema } = require('../../dto/company/document.dto');
...
exports.createDocument = async (req, res) => {
  try {
    ...
    let mimeType = null;
    if (req.file) {
      filePath = path.join(req.file.destination || '', req.file.filename || req.file.originalname);
